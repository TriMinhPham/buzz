...
use buzz_core::kind::{
    ...
    KIND_JOB_PAYMENT, KIND_JOB_PROGRESS, KIND_JOB_REQUEST, KIND_JOB_RESULT, KIND_JOB_REVIEW,
    KIND_LEDGER_TOPUP, KIND_LONG_FORM, KIND_MANAGED_AGENT, KIND_MEMBER_ADDED_NOTIFICATION,
